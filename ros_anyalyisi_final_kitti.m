...
image_dir='/home/vinayb/icra_17/data/KITTI/images/0001/%06d.png';
...
load /home/vinayb/icra_17/data/KITTI/data_tracking_det_2_lsvm/training/det_02_withoverlap/0001_withoverlap.mat
...
for i=1:(length(tracklets)-20)
 ...
 %   read images 
    image_1=imread(sprintf(image_dir,i-1));
    image_2=imread(sprintf(image_dir,i+delt-1));
...
figure(1),showMatchedFeatures(image_1,image_2,visiblePoints_frame1_forward,visiblePoints_frame2_forward);
    ...
    for j=1:length(tracklets{1,i})
       ...
       for k=1:length(tracklets{1,i+delt})
           ...
           temp1=tracklets{1,i}{1,j}(1,19);
           temp2=tracklets{1,i+delt}{1,k}(1,19);
            
           temp1=(temp1{1});
           temp2=(temp2{1});
           if(temp1==temp2)   % Correct Matches 
            ...
            bx1=tracklets{1,i}{j}(1,7);
            by1=tracklets{1,i}{j}(1,8);
            bh1=tracklets{1,i}{j}(1,9);
            bw1=tracklets{1,i}{j}(1,10);
            ...
            bx2=tracklets{1,i+delt}{1,k}(1,7);
            by2=tracklets{1,i+delt}{1,k}(1,8);
            bh2=tracklets{1,i+delt}{1,k}(1,9);
            bw2=tracklets{1,i+delt}{1,k}(1,10);
            ...
            %   bbox1=[tracklets{1,i}{1,j}(1,3),tracklets{1,i}{1,j}(1,3)+tracklets{1,i}{1,j}(1,5),tracklets{1,i}{1,j}(1,4),tracklets{1,i}{1,j}(1,4)+tracklets{1,i}{1,j}(1,6)];
                bbox1=[bx1,bx1+bh1,by1,by1+bw1]+1;
                bbox2=[bx2,bx2+bh2,by2,by2+bw2]+1;
                
                bbox1_spatial=[bx1,by1,bh1,bw1]+1;
                bbox2_spatial=[bx2,by2,bh2,bw2]+1;
...
%            
%              subplot(2,2,1),imshow(image_1(by1:by1+bw1,bx1:bx1+bh1));
%              subplot(2,2,2),imshow(image_2(by2:by2+bw2,bx2:bx2+bh2));
% %              
% pause(1);
